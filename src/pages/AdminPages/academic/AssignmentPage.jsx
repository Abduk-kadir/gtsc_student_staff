...
const AssignmentPage = () => {
  ...
  return (
    <section className="staff-dashboard staff-dashboard-page">
      <h3 className="sd-section-title">Assignment</h3>

      <div className="sd-mode-grid" role="group" aria-label="Assignment mode">
        <button
          type="button"
        ...
        >
          ...
          <span className="sd-mode-btn__body">
            ...
            <span className="sd-mode-btn__hint">See assignment report</span>
          </span>
        </button>
        ...
        >
          <span className="sd-mode-btn__icon sd-mode-btn__icon--emerald">
            <Icon icon="solar:document-text-bold-duotone" aria-hidden />
          </span>
          <span className="sd-mode-btn__body">
            <span className="sd-mode-btn__label">Take</span>
            <span className="sd-mode-btn__hint">Send assignment</span>
          </span>
        </button>
      </div>
      ...
      <div className="staff-dashboard-page__content">
        {isShowView ? (
          ...
          <CommonSendDataStudent formType="assignment" />
        )}
      </div>
    </section>
  )
