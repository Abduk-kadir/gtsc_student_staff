                ...
                <div className="login-form__grid">
                  <div className="login-field">
                    ...
                    <Field
                      ...
                      className={`login-field__input${touched.email && errors.email ? ' is-invalid' : ''
                        }`}
                    />
                    <ErrorMessage
                      name="email"
                  ...
                  <div className="login-field">
                    ...
                    <Field
                      ...
                      className={`login-field__input${touched.password && errors.password ? ' is-invalid' : ''
                        }`}
                    />
                    <ErrorMessage
                      name="password"
                  ...
                  <div className="login-field login-field--full">
                    ...
                    <Field
                      ...
                      id="academicYear"
                      name="academicYear"
                      className={`login-field__input${touched.academicYear && errors.academicYear
                          ? ' is-invalid'
                          : ''
                        }`}
                    >
                  ...
                  <div className="login-field login-field--full">
                    ...
                    <div className="login-role">
                      <button
                        type="button"
                        className={`login-role__btn${values.loginAs === 'Parent'
                      ...
                      <button
                        type="button"
                        className={`login-role__btn${values.loginAs === 'Staff'
                            ? ' login-role__btn--active'
                            : ''
                          }`}
